...
#define			BUM_SET_TURN_MODE_AUTO_1	B00000101																						//								5 - Поворотник включается автоматически, при наличии линии под любым из двух самых крайних датчиков со стороны поворотника.
#define			BUM_SET_TURN_MODE_AUTO_2	B00000110																						//								6 - Поворотник включается автоматически, при наличии линии под любым из трех самых крайних датчиков со стороны поворотника.
#define			BUM_SET_TURN_MODE_AUTO_3	B00000111																						//								7 - Поворотник включается автоматически, при наличии линии под любым из четырёх датчиков со стороны поворотника.
